...
func Redeem(ctx context.Context, tok Token, longTerm refs.FeedRef, opts ...client.Option) error {
	...
	opts = append(opts, client.WithContext(ctx))

	// now use the invite
	inviteClient, err := client.NewTCP(inviteKeyPair, tok.Address, opts...)
	if err != nil {
